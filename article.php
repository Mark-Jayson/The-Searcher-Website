...
$query = "SELECT a.headline, a.subhead, a.content_text, a.pub_date, c.category_name, m.media_filepath, CONCAT(e.editor_name, ' | ', DATE_FORMAT(a.pub_date, '%M %d, %Y')) AS author_date
          FROM article AS a
